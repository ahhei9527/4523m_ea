...
<div class="dashboard-container" style="max-width:1100px;">
    ...
    <?php if (empty($cart_items)): ?>
        <div style="text-align:center; padding:4rem 0; background:white; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.08);">
    ...
    <?php else: ?>
        <div class="cart-table-container" style="overflow-x:auto; background:white; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.08);">
